...
(year < 5) ? alert (`Привет, малыш!`) :
(year < 18) ? alert (`Привет!`) :
(year < 100 ) ? alert (`Здравствуйте`) :
alert (`Какой странный возраст`);


/* Практика № 2 */

let nameJS = prompt (`Какое официальное название JS?`, `ECMAScript`);
...
let value = +prompt (`Введите любое число`, `43`);
...
let result = (value + year < 4) ? `Мало` : `Много`;
