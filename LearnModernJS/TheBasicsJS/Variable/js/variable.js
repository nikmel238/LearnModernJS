...
console.log(newName);
const INFO =
  'const используется для объявления постоянных переменных, при чем если переменная заранее известна, то обзываем ее прописными буквами';
console.log(INFO);
